...
def main():
    ...
    list_parser = subparsers.add_parser(
        "list-designs", help="List available standard fractional factorial designs"
    )
    ...
    analyze_parser = subparsers.add_parser(
        "analyze", help="Run ANOVA on experiment results CSV"
    )
    ...
    analyze_parser.add_argument(
        "--output-report", "-o", type=str, help="Save report to Markdown or HTML"
    )
    ...
    if args.command == "list-designs":
        ...
        anova_res = ANOVAEngine.run_anova(
            data=df, factor_cols=f_cols, target_col=args.target
        )
